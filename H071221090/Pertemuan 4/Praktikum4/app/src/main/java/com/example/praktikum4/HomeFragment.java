...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        iv_posting.setOnClickListener(v -> {
            com.example.praktikum4.PostinganFragment postinganFragment = new com.example.praktikum4.PostinganFragment();
        ...
        iv_profile.setOnClickListener(v -> {
            com.example.praktikum4.ProfileFragment profileFragment = new com.example.praktikum4.ProfileFragment();
            FragmentManager fragmentManager = getParentFragmentManager();
            fragmentManager
                    .beginTransaction()
