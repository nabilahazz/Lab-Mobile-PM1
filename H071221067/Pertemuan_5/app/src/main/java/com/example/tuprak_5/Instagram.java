...
public class Instagram implements Parcelable {
    ...
    public Instagram(String hirtoria, String HirtoriA, String konten, int hirtoria_avatar, Uri selectedImageUri) {
        this.username = hirtoria;
        this.name = HirtoriA;
        this.desc = konten;
        this.fotoProfile = hirtoria_avatar;
