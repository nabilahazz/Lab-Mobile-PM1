package com.example.tuprak_4.fragment;
...
import com.example.tuprak_4.Instagram;
import com.example.tuprak_4.R;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                Instagram instagram = new Instagram("hirtoria", "HirtoriA", konten, R.drawable.hirtoria, selectedImageUri);
