...
public class PostinganFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (selectedImageUri == null && konten.isEmpty()) { //kosong
            ...
            if (selectedImageUri != null && konten.isEmpty()) {
                Toast.makeText(getActivity(), "Isi konten dahulu", Toast.LENGTH_SHORT).show();
                return;
            }

            if (selectedImageUri == null && !konten.isEmpty()) {
                Toast.makeText(getActivity(), "Pilih gambar dahulu", Toast.LENGTH_SHORT).show();
                return;
            }


            Instagram instagram = new Instagram("Susanti", "snt", konten, R.drawable.profile, selectedImageUri);
